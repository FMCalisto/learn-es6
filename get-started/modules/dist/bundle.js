...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mathAddition = __webpack_require__(/*! math/addition */ 4);
	
	var addition = _interopRequireWildcard(_mathAddition);
	
	var _dataUsers = __webpack_require__(/*! data/users */ 5);
	
	console.log(_.where(_dataUsers.users, { age: 36 }));
...
/***/ function(module, exports) {
	...
	var users = [{ 'user': 'barney', 'age': 36, 'active': false, 'pets': ['hoppy'] }, { 'user': 'fred', 'age': 40, 'active': true, 'pets': ['baby puss', 'dino'] }];
	exports.users = users;
